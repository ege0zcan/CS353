...
<form style="text-align: center" action="" method="GET">
    ...
    <input type="date" name="day" placeholder="Post Date">
...
<form style="text-align: center" action="" method="POST">
    <div class="row">
            ...
            if (isset($_GET['jobTitle']) || isset($_GET['location']) || isset($_GET['type'] )){
                if($_GET['jobTitle']!= "" && $_GET['location']!= "" && $_GET['type']!= "" ) {
                    ...
                    if(isset($_GET['day']) && $_GET['day'] != ""){
                        $sql .= " WHERE date > '".$_GET['day']."' ";
                    }
                }
                if(isset($_GET['day']) && $_GET['day'] != ""){
                    $sql .= " AND date > '".$_GET['day']."' ";
                }
                ...
                while($job = mysqli_fetch_object($result)){
                    ...
                    echo(" <button name=\"submit\" type=\"submit\" style=\"border: 2px solid #808080; -webkit-transition-duration: 0.4s;padding: 10px 24px; margin:5px; border-radius: 8px;\" value=$jobID> $jobTitle </button>");
                }
        ...
        <div class="column">
            ...
            <br>
            <br>
            <button class="button" type = "submit" name="apply" style="display: inline-block; width: 20%;height: 5%;margin-left: 30.5px;  font-size: 14px;">Apply</button>
</form>
